...
void Level03::Init()
{
	...
	potion->active = true;
	potion->pos.Set(625.f, 80.f, 0.f);
	GoManager::GetInstance().Add(potion);

	potion = new HealthPotion();
	potion->active = true;
	potion->pos.Set(1614.f, 80.f, 0.f);
	GoManager::GetInstance().Add(potion);

	potion = new HealthPotion();
	potion->active = true;
	potion->pos.Set(2160.f, 80.f, 0.f);
	GoManager::GetInstance().Add(potion);
...
// Renders
void Level03::RenderMap(TileMap* map)
{
...
void Level03::RenderObject(GameObject* go)
{
	modelStack.PushMatrix();
...
void Level03::RenderWeaponObject(GameObject* go)
{
	if (go->view.x > 0)
	{
