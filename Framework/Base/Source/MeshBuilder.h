...
public:
	...
	static Mesh* GenerateBackground(const std::string &meshName, Color color, float repeat = 1.f);
	...
	static Mesh* GenerateTileSheet(const std::string &meshName, unsigned numRow, unsigned numCol);
	static SpriteAnimation* GenerateSpriteAnimation(const std::string &meshName, unsigned numRow, unsigned numCol);

	static Mesh* GenerateMinimap(const std::string &meshName, Color color, float length = 1.f, float texSize = 1.f);
