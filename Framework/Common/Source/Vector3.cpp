...
/*!
\brief
Lerp current vector towards target vector given time
...
*/
/******************************************************************************/
Vector3& Vector3::Lerp(Vector3 target, float time)
{
	x = (1 - time) * x + time * target.x;
	y = (1 - time) * y + time * target.y;
	z = (1 - time) * z + time * target.z;
	return *this;
}
